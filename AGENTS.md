...
- A visible change needs a release entry in `src/data/versions.ts` and `CHANGELOG.md`; `npm test` fails if the two disagree. See [`docs/versioning.md`](docs/versioning.md) for the scheme and when not to bump.
