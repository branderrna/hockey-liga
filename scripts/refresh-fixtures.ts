...
// src/data/matches.generated.ts. Run weekly by .github/workflows/refresh-fixtures.yml,
...
// Regenerated weekly from the league Google Sheet. See .github/workflows/refresh-fixtures.yml
