...
const CURRENT: Release = {
  ...
  notes: [
    ...
    "A round where the top and bottom halves play separately stays one league table, with points carried forward, so a team can still climb past the half above it.",
