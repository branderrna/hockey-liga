...
const CURRENT: Release = {
  ...
  date: "2026-09-13",
  notes: [
    "The league table on a phone now shows goal difference instead of the form run — the number that decides places level on points, rather than the one that does not.",
  ],
};
